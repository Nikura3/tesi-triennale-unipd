...
\input{capitoli/capitolo-3}             % tecnologie e strumenti
\input{capitoli/capitolo-4}             % descrizione dell'applicativo esistente
\input{capitoli/capitolo-5}				% sviluppo image recognition
\input{capitoli/capitolo-6}				% sviluppo lex
